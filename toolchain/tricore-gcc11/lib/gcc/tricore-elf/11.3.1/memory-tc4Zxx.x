...
__HEAP_MIN = 4K;
__CSA_SIZE = 8K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x4F00;
...
__INT_CODE_FLASH_BANK2_SIZE = 4M;
...
__INT_CODE_FLASH_BANK5_SIZE = 4M;
...
MEMORY
{
  ...
  PMU_PFLASH2 (rx!p): org = 0x80800000, len = 4M
  PMU_PFLASH3 (rx!p): org = 0x80A00000, len = 4M
  PMU_PFLASH4 (rx!p): org = 0x80E00000, len = 4M
  PMU_PFLASH5 (rx!p): org = 0x81200000, len = 4M
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC4Zxx");
