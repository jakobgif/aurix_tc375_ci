...
__HEAP_MIN = 4K;
__CSA_SIZE = 8K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x4C00;
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC4Pxx");
