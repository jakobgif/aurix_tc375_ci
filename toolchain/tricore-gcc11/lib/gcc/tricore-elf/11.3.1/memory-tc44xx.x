...
__HEAP_MIN = 4K;
__CSA_SIZE = 8K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x4400;
...
MEMORY
{
  ...
  PMU_PFLASH1 (rx!p): org = 0x80400000, len = 2M
  PMU_PFLASH2 (rx!p): org = 0x80600000, len = 2M
  PMU_DFLASH0 (w!xp): org = 0xAE000000, len = 256K
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC44xx");
